    ...
    return (
        <div className="min-h-screen bg-background flex flex-col font-sans">
            ...
            <main className="flex-1 pt-32 pb-24 px-4">
                {/* Background Glow */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-primary/20 blur-[150px] rounded-full pointer-events-none opacity-20" />
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    >
                        <div className="flex items-center gap-2 p-1.5 rounded-full bg-zinc-900/80 border border-white/10">
                            <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-start">
                        {plans.map((plan, index) => (
                            <motion.div
                                ...
                                className={cn(
                                    "relative rounded-3xl border p-6 lg:p-8 flex flex-col",
                                    plan.popular
                            ...
                            >
                                {/* Popular Badge */}
                                {plan.popular && (
                                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-xs font-bold text-white uppercase tracking-wider">
                                        Most Popular
                                    </div>
                                )}
                                ...
                                {/* Icon */}
                                <div className={cn(
                                    "w-14 h-14 rounded-2xl flex items-center justify-center mb-6 mx-auto",
                                ...
                                {/* Plan Name */}
                                <h3 className="text-lg font-bold text-white text-center mb-1">{plan.name}</h3>
                                ...
                                {/* CTA Button */}
                                <button className={cn(
                                    "w-full py-4 rounded-2xl font-bold text-sm uppercase tracking-wider transition-all active:scale-[0.98]",
                                    plan.popular
